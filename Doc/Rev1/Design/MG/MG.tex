...
\title{SE 3XA3: Module Guide\\Rhythm Master}
...
March 8, 2021 & 0.2 & Added anticipated changes\\
March 13, 2021 & 0.3 & Added the introduction, scope and purpose\\
March 17, 2021 & 0.5 & Finished module decomposition and hierarchy\\
\textcolor{red}{April 12, 2021} & \textcolor{red}{1.0} & \textcolor{red}{Updated module guide for Revision 1 submission}\\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{description}
\item [\refstepcounter{mnum} \mthemnum \label{m1}:] Button Controller \textcolor{red}{\sout{Handler}}
\item [\refstepcounter{mnum} \mthemnum \label{m2}:] \textcolor{red}{Load Settings} \textcolor{red}{\sout{Settings Data}}
\item [\refstepcounter{mnum} \mthemnum \label{m3}:]  \textcolor{red}{FileIO} \textcolor{red}{\sout{Save File Handler}}
...
\item [\refstepcounter{mnum} \mthemnum \label{m8}:]  \textcolor{red}{Populate Leaderboard} \textcolor{red}{\sout{Leaderboard Calculator}} 
...
\item [\refstepcounter{mnum} \mthemnum \label{m16}:]  \textcolor{red}{Complete Screen}
\item [\refstepcounter{mnum} \mthemnum \label{m17}:]  \textcolor{red}{Detect Key}
\item [\refstepcounter{mnum} \mthemnum \label{m18}:]  \textcolor{red}{Effect Manager}
\item [\refstepcounter{mnum} \mthemnum \label{m19}:]  \textcolor{red}{Leaderboard Entry}
\item [\refstepcounter{mnum} \mthemnum \label{m20}:]  \textcolor{red}{Quit Game}
\end{description}
...
& Leaderboard \\
& Instructions \\ 
& \textcolor{red}{Load Settings} \textcolor{red}{\sout{Settings Data}} \\
& Effects \\
& \textcolor{red}{FileIO} \textcolor{red}{\sout{Save File Handler}}\\
& \textcolor{red}{Complete Screen}\\
& \textcolor{red}{Detect Key}\\
& \textcolor{red}{Effect Manager}\\
& \textcolor{red}{Quit Game}\\
& \textcolor{red}{Leaderboard Entry}\\
\midrule

{Software Decision Module} & Note Spawner\\
& Collision Detector\\
& Score Calculator\\
& \textcolor{red}{Populate Leaderboard} \textcolor{red}{\sout{Leaderboard Calculator}} \\
& Game Manager\\
& Settings Data\\
\bottomrule
