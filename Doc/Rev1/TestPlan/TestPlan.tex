...
\item{\textcolor{red}{\sout{ FR-UI-13\\}}}

\textcolor{red}{\sout{Type: Functional, Manual, Dynamic}}
					
\textcolor{red}{\sout{Initial State: The leaderboard screen is being displayed}}
					
\textcolor{red}{\sout{Input: \term[Tester]{Tester} chooses to filter the score based on the time}}
					
\textcolor{red}{\sout{Output: The game should display a list of players and their respective score}}\textcolor{red}{\sout{ in the order that the tester chose.}}
					
\textcolor{red}{\sout{How test will be performed: A tester will open the leaderboard and check whether}}\textcolor{red}{\sout{ filtering the score by time displays the score according to that order.}}
...
\item{\textcolor{red}{NFR-2-LF2}\\}

\textcolor{red}{Type: Functional, Manual, Dynamic}
					
\textcolor{red}{Initial State: The \term[Tester]{tester} is playing a \term[Game track]{game track}}
					
\textcolor{red}{Condition: Game track is unpaused and in motion}
					
\textcolor{red}{Output: Visual effects and informational graphics produced by the game}
					
\textcolor{red}{How test will be performed: Gameplay visuals are to be further compared to those of \term{Frets on Fire}, since that game is considered complete. Any additional visuals on top of those included in the original implementation are to be analyzed for necessity. This data can be collected from the \term[Tester]{tester} using surveys.}
...
\item{\textcolor{red}{NFR-3-UH1}\\}

\textcolor{red}{Type: Functional, Manual, Dynamic}
					
\textcolor{red}{Initial State: The \term[Tester]{tester} is playing a \term[Game track]{game track}}
					
\textcolor{red}{Condition: Game track is being played}
					
\textcolor{red}{Output: Visual effects and informational graphics produced by the game}
					
\textcolor{red}{How test will be performed: Various \term[Tester]{testers} will be allowed to play the game and fill a survey to check whether the game was playable using two hands }
...
How test will be performed: \textcolor{red}{ Children greater or equal than $\hyperlink{min_age}{MIN\_AGE}$ who play the game should fill a binary survey with the options of agree and disagree }
...
How test will be performed: \term[Tester]{Testers} will provide their answer to question 6 of the \hyperref[sec:usersurvey]{\textbf{Usability Survey}}. Their responses will be assessed to determine if the level of difficulty is appropriate.

\item{\textcolor{red}{NFR-3-UH5}\\}

\textcolor{red}{Type: Functional, Manual, Dynamic}
					
\textcolor{red}{Initial State: The \term[Tester]{tester} read the instructions and has played \term[Game track]{game track}}
					
\textcolor{red}{How test will be performed: \term[Tester]{Testers} will read the instructions and fill a binary survey that asks whether the instructions were useful or not}

\item{\textcolor{red}{NFR-4-UH6}\\}

\textcolor{red}{Type: Functional, Manual, Dynamic}
					
\textcolor{red}{Initial State: The \term[Tester]{tester} has played \term[Game track]{game track}}
					
\textcolor{red}{How test will be performed: \term[Tester]{Testers} will fill a binary survey asking whether the game uses common symbols and game terms}
...
\item{\textcolor{red}{\sout{NFR-6-PE2}}}

\textcolor{red}{\sout{Type: Functional, Manual, Dynamic}}

\textcolor{red}{\sout{Initial State: In game, during gameplay}}

\textcolor{red}{\sout{Input: \term[Tester]{Tester} presses any button to hit a note}}

\textcolor{red}{\sout{Output: Recording of gameplay}}

\textcolor{red}{\sout{How test will be performed: Testers will record gameplay using the screen recorder}}\textcolor{red}{\sout{ of their choice. They will make an input then view the recording frame-by-frame,}}\textcolor{red}{\sout{ observing how many frames it takes for their input to be reflected on-screen.}}\textcolor{red}{\sout{ Assuming the framerate is known, each passed frame takes a known amount of time.}}

\item{\textcolor{red}{NFR-10-PE4}}
...
\item {\textcolor{red}{\sout{NFR-8-PE7}}}

\textcolor{red}{\sout{Type: Structural, Manual, Dynamic}}

\textcolor{red}{\sout{Initial State: Game contains just the original game track}}

\textcolor{red}{\sout{Input: A new game track created by the developers}}

\textcolor{red}{\sout{Result: Game can be played with no difference in gameplay with the new game track}}

\textcolor{red}{\sout{How test will be performed: Developers will create a new game track separate from}}\textcolor{red}{\sout{ the track that already exists in the game. They will then switch the game to run on}}\textcolor{red}{\sout{ the new track. When a new game is started, the new track will be the one that is}}\textcolor{red}{\sout{ playing. The new track should be playable by the game without changing the game's behaviour in any way.}}
...
\item{\textcolor{red}{\sout{NFR-9-PE9}}}

\textcolor{red}{\sout{Type: Functional, Manual, Dynamic}}

\textcolor{red}{\sout{Initial State: Game is not running.}}

\textcolor{red}{\sout{Condition: Computer is disconnected from the Internet.}}

\textcolor{red}{\sout{Result: Game runs the same as when there is an Internet connection available.}}

\textcolor{red}{\sout{How test will be performed: \term[Tester]{Testers} will disconnect their system from the Internet,}}\textcolor{red}{\sout{ then launch the game and proceed with gameplay. They will attempt to access high}}\textcolor{red}{\sout{ score lists, instructions, and the \term[Game track]{game track}. All operations should proceed identically}}\textcolor{red}{\sout{ to when the Internet connection was active.}}
...
& & LF1  & LF3 & UH2 & UH5 & PE1 & LF2 & PE6 & UH1 & UH5 & UH6 & PE4  \\ \cline{1-13}
    ...
    \multicolumn{1}{|c| } {NFR-1-LF1} &X&&&&&&&&&&\\ \cline{2-13}
        \multicolumn{1}{|c| }{} 	                  &
    \multicolumn{1}{|c| }{\textcolor{red}{NFR-2-LF2}} &  &&&&&\textcolor{red}{X}&&&&&  \\ \cline{2-13}
    \multicolumn{1}{|c| }{} 	                  &
    \multicolumn{1}{|c| }{NFR-2-LF3} &  & X & &&&&&&&&  \\ \cline{2-13}
    \multicolumn{1}{|c| }{} 	                  &
    \multicolumn{1}{|c| }{\textcolor{red}{NFR-3-UH1}} &&&&&&&&\textcolor{red}{X}&& & \\ \cline{2-13}
    \multicolumn{1}{|c| }{}                        &
    \multicolumn{1}{|c| } {NFR-3-UH2} &   &   &X  &&&&&&&& \\ \cline{2-13}
    \multicolumn{1}{|c| }{} 	                  &
    \multicolumn{1}{|c| }{\textcolor{red}{NFR-3-UH5}} &&&&&&&&&\textcolor{red}{X}&& \\ \cline{2-13}
    \multicolumn{1}{|c| }{} 	                  &
    \multicolumn{1}{|c| }{\textcolor{red}{NFR-4-UH6}} &  &&&&&&&&&\textcolor{red}{X}&  \\ \cline{2-13}
    \multicolumn{1}{|c| }{}                        &
    \multicolumn{1}{ |c| } {NFR-4-UH5} &   &   & &X&&&&&&& \\ \cline{2-13}
    \multicolumn{1}{|c| }{}                        &
    \multicolumn{1}{ |c| } {NFR-5-PE1} &   &   & &&X&&&&&& \\ \cline{2-13}
    \multicolumn{1}{|c| }{}                        &
    \multicolumn{1}{ |c| } {\textcolor{red}{\sout{NFR-6-PE2}}} &   &   & &&&&&&&& \\ \cline{2-13}
    \multicolumn{1}{|c| }{}                        &
    \multicolumn{1}{ |c| } {\textcolor{red}{NFR-7-PE4}} &   &   & &&&&X&&&&\textcolor{red}{X}  \\ \cline{2-13}
    \multicolumn{1}{|c| }{}                        &
    \multicolumn{1}{ |c| } {\textcolor{red}{\sout{NFR-8-PE7}}} &   &   & &&&&&&&&\\ \cline{2-13}
    \multicolumn{1}{|c| }{}                        &
    \multicolumn{1}{ |c| } {\textcolor{red}{\sout{NFR-9-PE9}}} &   &   & &&&&&&&& \\ \cline{1-13}
    % \multicolumn{1}{|c| }{}                        &
...
There will be no unit testing of output files conducted as \term{Rhythm Master} does not output any files.
